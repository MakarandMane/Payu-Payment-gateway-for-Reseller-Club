...
<html lang="en">
  ...
  <body style="background:#ecf0f1;">
    <form action="<?php echo $base_url; ?>" method="post" name="paymentpage">
      ...
      <input type="hidden" name="firstname" id="firstname" value="<?php echo $name1; ?>" />
      <input type="hidden" name="email" id="email" value="<?php echo $email1; ?>" />
      ...
      <input type="hidden" name="address1" value="<?php echo $address11; ?>" />
      <input type="hidden" name="address2" value="<?php echo $address21; ?>" />
      <input type="hidden" name="city" value="<?php echo $city1; ?>" />
      <input type="hidden" name="state" value="<?php echo $state1; ?>" />
      <input type="hidden" name="country" value="<?php echo $country1; ?>" />
      <input type="hidden" name="zipcode" value="<?php echo $zip1; ?>" />
